...
function SubAttributesCarisma() {
    const [seducao, setSeducao] = useState('');
    const [intimidar, setIntimidar] = useState('');
    const [persuadir, setPersuadir] = useState('');
                            ...
                            <div className="flex flex-row mt-1">
                                {toggleSeducao ? (
                                    <h2
                                        ...
                                        value={String(seducao + proficiencia)}
                                        readOnly
                                        disabled
                                    >{seducao + proficiencia}</h2>
                                ) : (
                                    <h2
                                        placeholder="mod"
                            ...
                            <div className="flex flex-row mt-1">
                                {toggleIntimidar ? (
                                    <h2
                                        placeholder="mod"
                                        className="ml-2 mt-1 w-11 pr-11 rounded-md border-gray-200 shadow-sm dark:border-gray-700 dark:bg-gray-800 text-white sm:text-sm"
                                        value={String(intimidar + proficiencia)}
                                        readOnly
                                        disabled
                                    >{intimidar + proficiencia}</h2>
                                ) : (
                                    <h2
                                        placeholder="mod"
                                        className="ml-2 mt-1 pr-11 w-11 rounded-md border-gray-200 shadow-sm dark:border-gray-700 dark:bg-gray-800 text-white sm:text-sm"
                                        value={String(intimidar)}
                                        readOnly
                                        disabled
                                    >{intimidar}</h2>
                                )}
                            ...
                            <div className="flex flex-row mt-1">
                                {togglePersuadir ? (
                                    <h2
                                        placeholder="mod"
                                        className="ml-2 mt-1 w-11 pr-11 rounded-md border-gray-200 shadow-sm dark:border-gray-700 dark:bg-gray-800 text-white sm:text-sm"
                                        value={String(persuadir + proficiencia)}
                                        readOnly
                                        disabled
                                    >{persuadir + proficiencia}</h2>
                                ) : (
                                    <h2
                                        placeholder="mod"
                                        className="ml-2 mt-1 pr-11 w-11 rounded-md border-gray-200 shadow-sm dark:border-gray-700 dark:bg-gray-800 text-white sm:text-sm"
                                        value={String(persuadir)}
                                        readOnly
                                        disabled
                                    >{persuadir}</h2>
                                )}
