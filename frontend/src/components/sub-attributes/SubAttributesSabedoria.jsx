...
function SubAttributesSabedoria({ modSabedoria }) {
    ...
    const [togglePespicacia, setTgglePespicacia] = useState(false);
    const [togglePercepcao, setTogglePercepcao] = useState(false);

    //Logicas de Toggle de proficiencia a proficienta está sendo definifa no useState
    ...
    const handleTogglePerspicacia = () => {
        setTgglePespicacia(!togglePespicacia);
        if (togglePespicacia) {
    ...
    const handleTogglePercepcao = () => {
        setTogglePercepcao(!togglePercepcao);
        if (togglePercepcao) {
