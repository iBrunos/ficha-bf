                ...
                <div className='flex flex-col'>
                    <div className='flex flex-row'>
                        <div className="ml-2 mt-2 rounded-xl max-w-sm flex-col ">
                            ...
                            />
                            <label className='ml-[5.5rem] cursor-pointer w-full rounded-md border-gray-200 shadow-sm dark:border-gray-700 dark:bg text-white sm:text-sm hover:border-blue-500 hover:shadow-md' htmlFor='upload-image'>
